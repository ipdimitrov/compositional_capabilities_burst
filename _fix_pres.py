...
if "Other Classes vs Burst Class (mean" in content:
    content = content.replace(
        "Other Classes vs Burst Class (mean", "Other Classes vs Special Class (mean", 1
    )
    print("2 OK")
...
content = content.replace(
    '"Burst Class Accuracy (free generation)"', '"Special Class Accuracy (free generation)"'
)
content = content.replace(
...
new6a = (
    """    for al, al_suffix in [("absolute", ""), ("start", "_aligned_start"), """
    """("end", "_aligned_end")]:
...
if old6b in content:
    ...
    new6b2 = """                                  f"overlay_burst{al_suffix}.png", groups=gr, align=al)"""  # noqa: E501
...
new6d = """                                  f"overlay_other{al_suffix}.png", loc="lower right", groups=gr, align=al)"""  # noqa: E501
if old6d in content:
