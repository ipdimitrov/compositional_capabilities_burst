...
def make_report(run_dir, results, cfg, per_run_fnames):
    ...
    pdf.body(
        ...
        f"chains. 80% for training, 20% held out for generalisation testing.")
    ...
    pdf.body(
        ...
        f"the remaining {n_b_pairs - nb_seen} are held out.")
    ...
    pdf.bul(f"end_mixed_50: 50% B at the end ({end_mixed_50_win} steps)")
